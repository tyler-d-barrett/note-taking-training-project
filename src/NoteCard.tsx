    ...
    <article className="group relative flex min-h-48 max-w-sm flex-col rounded border bg-white p-4 shadow-sm">
      <div className="absolute top-2 right-2 z-10 flex gap-2">
        <button
          ...
          className="scale-95 rounded-full bg-white/95 p-1.5 text-blue-600 opacity-0 shadow ring-1 ring-black/10 contrast-125 saturate-125 transition duration-300 group-hover:scale-100 group-hover:opacity-100 focus-visible:opacity-100"
        >
        ...
        <button
          ...
          className="scale-95 rounded-full bg-white/95 p-1.5 text-red-600 opacity-0 shadow ring-1 ring-black/10 contrast-125 saturate-125 transition duration-300 group-hover:scale-100 group-hover:opacity-100 focus-visible:opacity-100"
        >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
